...
class ImmoscoutSpider(scrapy.Spider):
    ...
    _realtors = {
        ...
        'homes_and_service':    'afea67b90e71d7562a2aa8a',
        'immo_next':            'ae81f6ec5468cd9',
        'stadt_und_land':       'a92a678d73456eed04d',
        'stuck_und_fuetting':   'a5532d12e73740bb09b85',
    ...
    def start_requests(self) -> Iterable[Request]:
        for name, encrypted_id in self._realtors.items():
